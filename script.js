document.querySelectorAll('.galeria img').forEach(image => {
    image.onclick = () => {
        ...
        document.querySelector('.popup-content img').src = image.getAttribute('src');
    }
});
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function openPopup(index) {
        ...
        if (currentItem.tagName.toLowerCase() === "img") {
            ...
            popupVideoElement.pause(); // Pausa o vídeo, se estiver reproduzindo
    ...
    function closePopup() {
        ...
        popupVideoElement.pause(); // Pausa o vídeo ao fechar o popup
    }
